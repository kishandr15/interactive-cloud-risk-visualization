...
const Graph = () => {
  ...
  return (
    <div className="w-full h-[600px] bg-white rounded-xl shadow p-4 relative">
      ...
      {/* Tooltip/Side Panel */}
      {selected && (
        <div className="absolute top-4 right-4 bg-white border rounded-lg shadow-lg p-3 z-20 min-w-[160px] max-w-[220px] text-sm">
